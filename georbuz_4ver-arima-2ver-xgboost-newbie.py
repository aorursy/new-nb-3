...
PATH_WDI = '/kaggle/input/covid-19-data-adding-world-development-indicators'

df_train = pd.read_csv(f'{PATH_WDI}/train_with_WDI.csv')

df_test = pd.read_csv(f'{PATH_WDI}/test_with_WDI.csv')
...
X_Train_CS
X_Test_CS
set(X_Train_CS.columns) - set(X_Test_CS.columns)
...
for country in countries:
    ...
    for state in states:
        ...
        X_Train_CS = X_Train_CS.drop(['ConfirmedCases', 'Fatalities', 'Id'], axis = 1)
        ...
        X_Test_CS = X_Test_CS.drop('ForecastId', axis = 1)
