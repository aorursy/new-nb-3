...
def get_nn_sub():
    ...
    coo_df = pd.read_csv("../input/countrydatafile/coordinates.csv").rename(columns={"Country/Region": "Country_Region"})
    ...
    def train_models(df, save=False):
        ...
        for i in range(NUM_MODELS):
            ...
            hist = model.fit(get_input(df), df[TARGETS],
                             ...
                             batch_size=1024, epochs=500, verbose=0, shuffle=True)
