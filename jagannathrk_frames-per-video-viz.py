...
frames_per_vid = [17, 25, 30, 32, 35, 36, 38, 39, 40, 49, 56, 64, 72, 80, 81, 82, 100]
...
df_viz = pd.DataFrame({'frames_per_vid': frames_per_vid, 'public_LB':public_LB})
df_plot = df_viz.plot(x='frames_per_vid', y='public_LB')
