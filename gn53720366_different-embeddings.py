...
## 投票
pred_glove_test_y = (pred_glove_test_y>0.35).astype(int)
...
## 投票
pred_fasttext_test_y = (pred_fasttext_test_y>0.33).astype(int)
del word_index, embeddings_index, all_embs, embedding_matrix, model, inp, x
import gc; gc.collect()
time.sleep(10)
...
## 投票
pred_paragram_test_y = (pred_paragram_test_y>0.34).astype(int)
del word_index, embeddings_index, all_embs, embedding_matrix, model, inp, x
import gc; gc.collect()
time.sleep(10)
