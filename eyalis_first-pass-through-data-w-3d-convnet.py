...
for patient in patients:
    ...
    try:
        ...
        slices = [cv2.resize(np.array(each_slice.pixel_array*each_slice.RescaleSlope +  each_slice.RescaleSlope),(IMG_PX_SIZE,IMG_PX_SIZE)) for each_slice in slices]
