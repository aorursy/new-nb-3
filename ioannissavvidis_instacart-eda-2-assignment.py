...
aisle_top= aisle_top.rename(columns={'product_id': 'total_products'})
aisle_top.head()
...
plt.xlabel('The first 10 Aisles with the most products/ and the number of each aisle ', size=15)
plt.ylabel('Number of Products', size=15)
# Modify the limits, I modified 
plt.ylim(0,1500)
plt.show()
...
plt.ylabel('mean_add_to_cart_order', size=15)
plt.xlim(-0.5,10)
plt.ylim(1,2.5)
plt.show()