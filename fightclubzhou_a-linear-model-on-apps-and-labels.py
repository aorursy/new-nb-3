...
for C in Cs:
    ...
    res_wei.append(score(LogisticRegression(C = C,class_weight = 'balanced')))

plt.semilogx(Cs, res_wei,'-o');
print(res_wei)

print(res)
Cs1 = np.logspace(-1.5,-0.5,6)

res_l1 = []

for C in Cs1:

    res_l1.append(score(LogisticRegression(C = C,penalty='l1')))

plt.semilogx(Cs1, res_l1,'-o');
plt.semilogx(Cs,res,'r-o',Cs1,res_l1,'b-o')
