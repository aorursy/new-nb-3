...
train = pd.read_csv('/kaggle/input/porto-seguro-safe-driver-prediction/train.csv', header=0)
train
test = pd.read_csv('/kaggle/input/porto-seguro-safe-driver-prediction/test.csv', header=0)
test
submission = pd.read_csv('/kaggle/input/porto-seguro-safe-driver-prediction/sample_submission.csv', header=0)
submission
# Check if not remain str data or not
train.dtypes
# Target feature is 0 or 1
