#Upvote -->> https://www.kaggle.com/hyeonho/pca-nusvc-0-95985
...
for i in range(512):
    ...
    data2 = StandardScaler().fit_transform(TruncatedSVD(n_components=40, random_state=4).fit_transform(data[cols]))
