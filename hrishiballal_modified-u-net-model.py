...
rle_0 = masks.query('ImageId=="fd0d324a7.jpg"')['EncodedPixels']
...
u6 = upsample(64, (2, 2), strides=(2, 2), padding='same') (d5)
u6 = layers.concatenate([u6, c4])
m6 = concatenate([d4,u6],  axis = 3)
c6 = layers.Conv2D(64, (3, 3), activation='relu', padding='same') (m6)
...
reduceLROnPlat = ReduceLROnPlateau(monitor='val_dice_coef', factor=0.33, 
                                   patience=5, 
                                   verbose=1, mode='auto', min_delta=0.0001, cooldown=2, min_lr=1e-8)
