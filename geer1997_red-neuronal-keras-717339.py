...
precision(model2)
arquitecturaFinal = [4000,4000,4000]
...
def func_model_reg():   
    ...
    x=Dense(4000, activation="relu", kernel_initializer='random_uniform', bias_initializer='zeros', kernel_regularizer=regularizers.l2(0.01))(x)
    ...
    x=Dense(4000, activation="relu", kernel_initializer='random_uniform', bias_initializer='zeros', kernel_regularizer=None)(x)
