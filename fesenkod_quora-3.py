...
pred_val_y, pred_test_y, best_score = train_pred(model_lstm_atten(embedding_matrix_2), epochs = 3) # Only Para
outputs.append([pred_val_y, pred_test_y, best_score, '2 LSTM w/ attention FASTTEXT'])
