...
from albumentations import Normalize, VerticalFlip, HorizontalFlip, Compose, ShiftScaleRotate, Transpose, RandomBrightness, RandomContrast, ChannelDropout
...
fig.update_layout(xaxis_title='Target', yaxis_title='Proportion', template="plotly_white", showlegend=False,
...
def set_image_transformations(dataset, aug):
    ...
    dataset.transformation = Compose([norm, vflip, hflip, ssr, tp, cd, rb, rc ]) if aug else norm
