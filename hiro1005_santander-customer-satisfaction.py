...
train = pd.read_csv('/kaggle/input/santander-customer-satisfaction/train.csv', header=0)
train.head(10)
test = pd.read_csv('/kaggle/input/santander-customer-satisfaction/test.csv', header=0)
test.head(10)
submission = pd.read_csv('/kaggle/input/santander-customer-satisfaction/sample_submission.csv', header=0)
submission.head(10)
target_col = 'TARGET'
drop_col = ['ID', 'TARGET']
