...
train = pd.read_csv('../input/train.csv',
                    dtype={'is_booking':bool,'orig_destination_distance':np.int32,'srch_destination_id':np.int32, 'hotel_cluster':np.int32},
                     usecols=['srch_destination_id','orig_destination_distance',
...
print('-'*38)
for chunk in train:
    agg = chunk.groupby(['srch_destination_id','orig_destination_distance',
