...
weights_lambda = 0.99 # reflect the weight decay for distant days
...
for i, case in enumerate(cases):
    ...
    for j in range(len(x0)//3):
        ...
        bounds.append(((case[-1]*2 - case[-8])*((case[-1]+1)/(case[-8]+1)),None)) 
...
for i in range(len(x0)//3):
    ...
    bounds.append(((cases[i,-1]*2 - cases[i,-8])*((cases[i,-1]+1)/(cases[i,-8]+1)),None)) 
...
for i in range(3):
    ...
    part_func = partial(fun, cases = cases, regularisation = 0.01)
...
for i in range(3):
    ...
    part_func = partial(fun, cases = cases, regularisation = 0.1)
