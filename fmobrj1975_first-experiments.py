...
learn.model
learn.lr_find()
learn.fit_one_cycle(40, 4e-3, cbs=SaveModelCallback(fname='best'))
learn.load('best')
learn.fit_one_cycle(40, 1e-3, cbs=SaveModelCallback(fname='best2'))
learn.load('best2')
learn.fit_one_cycle(40, 1e-3, cbs=SaveModelCallback(fname='best3'))
learn.load('best3')
learn.fit_one_cycle(40, 5e-4, cbs=SaveModelCallback(fname='best4'))
learn.load('best4')
learn.fit_one_cycle(40, 5e-4, cbs=SaveModelCallback(fname='best5'))
learn.load('best5')
learn.fit_one_cycle(40, 5e-4, cbs=SaveModelCallback(fname='best6'))
learn.load('best6')
learn.fit_one_cycle(40, 5e-4, cbs=SaveModelCallback(fname='best7'))
learn.load('best7')
learn.fit_one_cycle(100, 5e-4, cbs=SaveModelCallback(fname='best8'))
learn.load('best8') #0,3227
learn.fit_one_cycle(100, 5e-4, cbs=SaveModelCallback(fname='best9'))
learn.load('best9') #0.322015
learn.fit_one_cycle(100, 8e-4, cbs=SaveModelCallback(fname='best10'))

np.array(learn.recorder.values)[:,1].min() #menor valid loss
learn.load('best10')

learn.fit_one_cycle(100, 5e-4, cbs=SaveModelCallback(fname='best11'))
...
learn = tabular_learner(dls, layers=[300,250], loss_func=MSELossFlat(),
                        ...
                        metrics=[exp_rmspe, rmse])#, embed_p=0.02
learn.lr_find()
learn.fit_one_cycle(40, 2e-3, cbs=SaveModelCallback(fname='fat_best'))

np.array(learn.recorder.values)[:,1].min()
learn.load('fat_best')

learn.fit_one_cycle(100, 1e-3, cbs=SaveModelCallback(fname='fat_best2'))

np.array(learn.recorder.values)[:,1].min()
learn.load('fat_best2')

learn.fit_one_cycle(100, 1e-3, cbs=SaveModelCallback(fname='fat_best3'))

np.array(learn.recorder.values)[:,1].min()
learn.load('fat_best3')

learn.fit_one_cycle(100, 8e-4, cbs=SaveModelCallback(fname='fat_best4'))

np.array(learn.recorder.values)[:,1].min()
learn.load('fat_best4')
preds, y = learn.get_preds()
preds
y
