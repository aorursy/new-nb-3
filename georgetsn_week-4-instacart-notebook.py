...
sns.countplot(ax=axes[0], x='order_dow', data=orders_first, color='red').set_title('First order for each costumer by day of the week')
sns.countplot(ax=axes[1], x='order_dow', data=orders_second, color='red').set_title('Second order for each costumer by day of the week')
