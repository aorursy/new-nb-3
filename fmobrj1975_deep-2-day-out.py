...
#df['is_valid'] = np.where(df['Date']<'2020-03-19', False, True)
...
learn.model
learn.lr_find()
learn.fit_one_cycle(40, 1e-2, cbs=SaveModelCallback(fname='best_2day'))
learn.load('best_2day')
learn.fit_one_cycle(40, 1e-3, cbs=SaveModelCallback(fname='best2_2day'))
learn.load('best2_2day')
learn.fit_one_cycle(40, 1e-3, cbs=SaveModelCallback(fname='best3_2day'))
learn.load('best3_2day')
learn.fit_one_cycle(40, 5e-4, cbs=SaveModelCallback(fname='best4_2day'))
learn.load('best4_2day')
learn.fit_one_cycle(40, 5e-4, cbs=SaveModelCallback(fname='best5_2day'))
learn.load('best5_2day')
learn.fit_one_cycle(40, 5e-4, cbs=SaveModelCallback(fname='best6_2day'))
learn.load('best6_2day')
learn.fit_one_cycle(40, 5e-4, cbs=SaveModelCallback(fname='best7_2day'))
learn.load('best7_2day')
learn.fit_one_cycle(100, 5e-4, cbs=SaveModelCallback(fname='best8_2day'))
learn.load('best8_2day') #0,3227
learn.fit_one_cycle(100, 5e-4, cbs=SaveModelCallback(fname='best9_2day'))
np.array(learn.recorder.values)[:,1].min() #menor valid loss
learn.load('best9_2day') #0,3227
learn.fit_one_cycle(100, 5e-4, cbs=SaveModelCallback(fname='best10_2day'))
np.array(learn.recorder.values)[:,1].min() #menor valid loss
learn.load('best10_2day')
learn.fit_one_cycle(100, 5e-4, cbs=SaveModelCallback(fname='best11_2day'))
np.array(learn.recorder.values)[:,1].min() #menor valid loss
learn.load('best11_2day')
learn.fit_one_cycle(100, 5e-4, cbs=SaveModelCallback(fname='best12_2day'))
np.array(learn.recorder.values)[:,1].min() #menor valid loss
learn.load('best12_2day')
learn.fit_one_cycle(100, 5e-4, cbs=SaveModelCallback(fname='best13_2day'))
np.array(learn.recorder.values)[:,1].min() #menor valid loss
learn.load('best13_2day')
learn.fit_one_cycle(100, 5e-4, cbs=SaveModelCallback(fname='best14_2day'))
np.array(learn.recorder.values)[:,1].min() #menor valid loss
learn.load('best13_2day')
learn.fit_one_cycle(100, 5e-4, cbs=SaveModelCallback(fname='best14_2day'))
np.array(learn.recorder.values)[:,1].min() #menor valid loss
learn.load('best14_2day')
learn.fit_one_cycle(100, 5e-4, cbs=SaveModelCallback(fname='best15_2day'))
np.array(learn.recorder.values)[:,1].min() #menor valid loss
learn.load('best15_2day')
learn.fit_one_cycle(100, 5e-4, cbs=SaveModelCallback(fname='best16_2day'))
np.array(learn.recorder.values)[:,1].min() #menor valid loss
learn.load('best16_2day')
learn.fit_one_cycle(100, 5e-4, cbs=SaveModelCallback(fname='best17_2day'))
np.array(learn.recorder.values)[:,1].min() #menor valid loss
learn.load('best17_2day')
learn.fit_one_cycle(100, 5e-4, cbs=SaveModelCallback(fname='best18_2day'))
np.array(learn.recorder.values)[:,1].min() #menor valid loss
learn.load('best18_2day')
learn.fit_one_cycle(100, 5e-4, cbs=SaveModelCallback(fname='best19_2day'))
np.array(learn.recorder.values)[:,1].min() #menor valid loss
learn.load('best18_2day')
...
learn = tabular_learner(dls, layers=[300,250], loss_func=MSELossFlat(),
                        ...
                        metrics=[exp_rmspe, rmse])#, embed_p=0.02
learn.lr_find()
learn.fit_one_cycle(40, 3e-3, cbs=SaveModelCallback(fname='fat_best'))
np.array(learn.recorder.values)[:,1].min()
learn.load('fat_best')
learn.fit_one_cycle(100, 1e-3, cbs=SaveModelCallback(fname='fat_best2_2day'))
np.array(learn.recorder.values)[:,1].min()
learn.load('fat_best2_2day')
learn.fit_one_cycle(100, 8e-4, cbs=SaveModelCallback(fname='fat_best3_2day'))
np.array(learn.recorder.values)[:,1].min()
learn.load('fat_best2_2day')
preds, y = learn.get_preds()
preds
