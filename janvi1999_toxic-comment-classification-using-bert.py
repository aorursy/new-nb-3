...
BERT_VOCAB= '../input/multi-cased/multi_cased_L-12_H-768_A-12/vocab.txt'

BERT_INIT_CHKPNT = '../input/multi-cased/multi_cased_L-12_H-768_A-12/bert_model.ckpt'

BERT_CONFIG = '../input/multi-cased/multi_cased_L-12_H-768_A-12/bert_config.json'
...
merged_df.head()
submission = merged_df.drop(['content','lang','severe_toxic','obscene','threat','insult','identity_hate'], axis=1)
