...
print(model.summary())
train_history = model.fit(train_dfX, train_dfY, batch_size=512, epochs=epochs+5, validation_data=(val_dfX, val_dfY))
...
precision(model2)
arquitecturaFinal = arquitectura1
