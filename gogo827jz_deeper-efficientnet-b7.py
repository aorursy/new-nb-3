...
checkpoint = tf.keras.callbacks.ModelCheckpoint('DeepEfficientNetB7.h5', monitor='val_sparse_categorical_accuracy', verbose=1, 
...
model.load_weights('DeepEfficientNetB7.h5')
...
np.save('DeepEfficientNetB7_proba.npy', probabilities)
